...
{
    public class DonutConvertListName
    {
        [SuppressMessage("ReSharper", "All")]
        public static readonly string[] RussianNameNumbers =
        {
            "тысяча", "миллион", "миллиард", "триллион", "квадриллион", "квинтиллион",
            "секстиллион", "септиллион", "октиллион", "нониллион", "дециллион",
            "ундециллион", "дуодециллион", "тредециллион", "кваттюордециллион", "квиндециллион",
            "сексдециллион", "септендециллион", "октодециллион", "новемдециллион", "вигинтиллион",
            "унвигинтиллион", "дуовигинтиллион", "тревигинтиллион", "кваттуорвигинтиллион",
            "квинвигитиллион", "сексвигинтиллион", "септенвигинтиллион", "октовигиллион", "новэмвигинтиллион",
            "тригинтиллион", "унтригинтиллион", "дуотригинтиллион", "третригинтиллион", "кваттуортригинтиллион",
            "квинтригинтиллион", "секстригинтиллион", "септентригинтиллион", "октотригинтиллион",
            "новемтригинтиллион", "квадрагинтиллион", "неквадрагинтиллион", "дуоквадрагинтиллион",
            "треквадрагинтиллион", "кваттюорквадрагинтиллион", "квинквадрагинтиллион", "сексквадрагинтиллион",
            "септенквадрагинтиллион", "октоквадрагинтиллион", "новемквадрагинтиллион", "квинквагинтиллион",
            "неквинквагинтиллион", "дуоквинквагинтиллион", "треквинквагинтиллион", "кваттюорквинквагинтиллион",
            "квинквинквагинтиллион", "сексквинквагинтиллион", "септенквинквагинтиллион", "октохвинквагинтиллион",
            "новемквинквагинтиллион", "сексагинтиллион", "унсексагинтиллион", "дуосексагинтиллион", "тресекагинтиллион",
            "кваттуорсекагинтиллион", "квинсексагинтиллион", "секссекагинтиллион", "септенсекагинтиллион",
            "октосекагинтиллион", "новемсекагинтиллион", "септуагинтиллион", "унсептуагинтиллион",
            "дуосептуагинтиллион", "тресептуагинтиллион", "кваттуорсептуагинтиллион", "квинсептуагинтиллион",
            "секссептуагинтиллион", "септенсептуагинтиллион", "октосептуагинтиллион", "новемсептуагинтиллион",
            "октогинтиллион", "унооктогинтиллион", "дуооктогинтиллион", "треоктогинтиллион", "кваттуороктогинтиллион",
        ...
        [SuppressMessage("ReSharper", "All")]
        public static readonly string[] EnglishNameNumbers =
        {
